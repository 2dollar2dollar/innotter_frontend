...
ENV REACT_APP_USERS_API_URL=$USERS_API_URL
ENV REACT_APP_RESIZER_API_URL=$RESIZER_API_URL
ENV AUTH_API_URL=$AUTH_API_URL
ENV POSTS_API_URL=$POSTS_API_URL
ENV USERS_API_URL=$USERS_API_URL
ENV RESIZER_API_URL=$RESIZER_API_URL

RUN echo "AUTH_API_URL=$AUTH_API_URL" > .env && \
    echo "POSTS_API_URL=$POSTS_API_URL" >> .env && \
    echo "USERS_API_URL=$USERS_API_URL" >> .env && \
    echo "RESIZER_API_URL=$RESIZER_API_URL" >> .env && \
    echo "REACT_APP_AUTH_API_URL=$AUTH_API_URL" >> .env && \
    echo "REACT_APP_POSTS_API_URL=$POSTS_API_URL" >> .env && \
    echo "REACT_APP_USERS_API_URL=$USERS_API_URL" >> .env \
    echo "REACT_APP_RESIZER_API_URL=$RESIZER_API_URL" >> .env
